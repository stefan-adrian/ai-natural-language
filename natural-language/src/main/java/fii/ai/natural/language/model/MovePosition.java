...
public class MovePosition{
    ...
    public String getInitialStateFEN() { return initialStateFEN; }

    public void setInitialStateFEN(String initialStateFEN) { this.initialStateFEN = initialStateFEN; }

    public List<Node> getVariants() { return variants; }

    public void setVariants(List<Node> variants) { this.variants = variants; }
